...
function TriggerNode({ data }: { data: { label: string; triggerType: string } }) {
  return (
    <div className={cn('rounded-xl border-2 p-4 min-w-50 shadow-sm', ACTION_COLORS.trigger)}>
...
function ActionNode({ data }: { data: { label: string; actionType: string; config?: Record<string, unknown> } }) {
  ...
  return (
    <div className={cn('rounded-xl border-2 p-4 min-w-50 shadow-sm', colorClass)}>
...
function DelayNode({ data }: { data: { label: string; amount?: number; unit?: string } }) {
  return (
    <div className={cn('rounded-xl border-2 p-4 min-w-40 shadow-sm', ACTION_COLORS.delay)}>
      <Handle type="target" position={Position.Top} />
      <div className="flex items-center gap-2 mb-1">
...
function ConditionNode({ data }: { data: { label: string } }) {
  return (
    <div className={cn('rounded-xl border-2 p-4 min-w-50 shadow-sm', ACTION_COLORS.ifElse)}>
      <Handle type="target" position={Position.Top} />
      <div className="flex items-center gap-2 mb-1">
